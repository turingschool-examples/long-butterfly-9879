...
RSpec.describe Ride, type: :model do
  ...
  describe "class methods" do 
    ...
    it "self.years_experience_rides" do 
      ...
      expect(@amusement_park_1.rides.years_experience_rides).to eq([@ride2, @ride1, @ride3])
      expect(@amusement_park_1.rides.years_experience_rides.first.average.to_i).to eq(9)
      expect(@amusement_park_1.rides.years_experience_rides.second.average.to_i).to eq(7)
      expect(@amusement_park_1.rides.years_experience_rides.third.average.to_i).to eq(5)
